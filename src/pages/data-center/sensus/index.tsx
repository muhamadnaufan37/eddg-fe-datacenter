...
const SensusMenuPage = () => {
  ...
  const menus = [
    ...
    {
      title: "Buat Data",
      description: "Tambahkan data sensus baru ke sistem.",
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
              Tampilan dibuat terpisah agar tidak menumpuk pilihan di awal.
            </p>
          </div>
          <div>
            <button
