  ...
  const menus = [
    {
      title: "Cari Data",
      description:
        "Cari peserta CAI berdasarkan nama lengkap, tanggal lahir, dan jenis kelamin.",
      icon: <FiSearch size={22} />,
      path: "/digital-data/cai/search",
    },
    {
      title: "Buat Data",
      description: "Tambahkan data peserta CAI baru ke sistem.",
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
              Pisahkan pencarian dan input data supaya alurnya lebih jelas.
            </p>
          </div>
          <div>
            <button
